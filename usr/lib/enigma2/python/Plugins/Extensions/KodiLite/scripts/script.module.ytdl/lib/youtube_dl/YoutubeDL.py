...
class YoutubeDL(object):
    ...
    def urlopen(self, req):
        #print "In YoutubeDL-py urlopen req =", req
        """ Start an HTTP download """
        if isinstance(req, compat_basestring):
            req = sanitized_Request(req)
        res = self._opener.open(req, timeout=self._socket_timeout)
        #print "In YoutubeDL-py urlopen res =", res   
    ...
    def _setup_opener(self):
        ...
        try:
               ...
               opener = compat_urllib_request.build_opener(
                       urllib2.HTTPSHandler(context=ctx), proxy_handler, https_handler, cookie_processor, ydlh, data_handler, file_handler)
        except:
               opener = compat_urllib_request.build_opener(
