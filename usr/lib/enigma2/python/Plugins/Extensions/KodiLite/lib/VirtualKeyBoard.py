...
class VirtualKeyBoard(Screen):
    skin = '''<screen name="KodiLiteVKskin" position="center,center" size="1280,680" zPosition="99" title="Virtual keyboard">
                  <ePixmap pixmap="skin_default/vkey_text.png" position="300,245" zPosition="-4" size="542,52" alphatest="on" />
                  <widget source="country" render="Pixmap" position="60,400" size="60,40" alphatest="on" borderWidth="2" borderColor="yellow" >
                      <convert type="ValueToPixmap">LanguageCode</convert>
                  </widget>
                  <eLabel text="language" position="60,350" size="100,35" font="Regular;21" foregroundColor="white" backgroundColor="yellow" />
                  ...
                  <widget name="list" position="250,300" size="1040,240" selectionDisabled="1" transparent="1" />
                  ...
                  <widget name="suggestlist" position="900,50" size="300,180" selectionDisabled="1" transparent="1" />
                  <eLabel text="Press red for history" position="50,10" size="300,35" font="Regular;21" foregroundColor="red" backgroundColor="white" />
                  <widget name="historylist" position="65,50" size="200,200" selectionDisabled="1" transparent="1" />
              </screen>'''
    ...
    def __init__(self, session, title='', text=''):
        ...
        print "Here in VirtualKeyBoard self['list'] =", self['list']
